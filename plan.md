...
| 3 | **ปัญหา → วิธีช่วย** (ใหม่ตามข้อเสนอแนะ) | บริการนี้แก้ปัญหาฉันอย่างไร |
| 4 | เหมาะกับใคร | ช่วยฉันได้ไหม |
| 5 | จุดเด่น / วิธีทำงาน (Construction: ใช้ถ้อยคำพันธมิตรที่ล็อก) | ทำไมเลือกเรา |
| 6 | **กรณีศึกษา / ผลงานที่เกี่ยวข้อง** + ลิงก์ Portfolio | ทำได้จริงไหม · มีเคสสำเร็จไหม |
| 7 | **รีวิวลูกค้า** (ถ้ารีวิวของเสานี้มี) | คนอื่นว่าอย่างไร |
| 8 | พื้นที่บริการ | รับงานที่ฉันอยู่ไหม |
| 9 | CTA → Contact (preselect เสาบริการ) | ติดต่อยังไง |
| 10 | Related services + กลับฮับ | internal linking |
...
```
Header
Hero          — แบรนด์ · หนึ่ง headline · หนึ่ง sub · CTA · full-bleed
Services hub  — 4 ลิงก์: Real Estate · Marketing · Construction · Consulting
Why us        — สั้น ๆ
Portfolio teaser — ผลงานคุณภาพสูง 3–6 ชิ้น + ลิงก์ Portfolio
Testimonials teaser — รีวิวลูกค้า 1–3 รายการ (เมื่อมี) + ลิงก์ Portfolio
CTA band      — ไป Contact
Footer
```
...
- ต้องมีบล็อก **ปัญหา → วิธีช่วย** + เคส/ผลงานที่เกี่ยวข้อง + รีวิว (ถ้ามี)  
...
- มีปัญหา → วิธีช่วย ต่อกลุ่มย่อยหลัก (ไม่จำเป็นครบ 6 ชุดถ้าเนื้อหายังไม่พอ — อย่างน้อย 2–3)  
...
- ปัญหา → วิธีช่วย ต้องสอดคล้องกับโมเดลพันธมิตร · ไม่โอเวอร์เคลม  

### 5.5 Consulting (`/th/consulting` · `/en/consulting`)
- กลยุทธ์ธุรกิจ · การตลาด · การพัฒนาโครงการ · การวางแผนขาย · ที่ปรึกษาโครงการ  
- เน้นปัญหาธุรกิจที่แก้ได้ (ไม่ใช่แค่รายการบริการ)  

### 5.6 Portfolio (`/th/portfolio` · `/en/portfolio`)
- ศูนย์รวม **ผลงานที่ผ่านมา** ทั้งสี่ด้าน  
- ชนิดรายการ: `project` (ภาพ/วิดีโอ) · `case-study` (โจทย์ / สิ่งที่ทำ / ผลลัพธ์) · `testimonial`  
- ตัวกรองตาม 4 เสา  
- สื่อ: **ภาพถ่ายและวิดีโอคุณภาพสูง** เท่านั้น · poster · ไม่ auto-play เสียง · lazy-load  
- โครงข้อมูลรองรับการ **เพิ่มผลงานใหม่ทีหลัง** โดยแก้ `media.json` + copy โดยไม่รื้อหน้า (อัปเดตต่อเนื่อง = กระบวนการหลังเปิดไซต์ / CMS ในเฟส 2)  
...
| **Portfolio** | กรอง 4 เสา · ภาพ+วิดีโอคุณภาพสูง · เคสศึกษา · รีวิว · lazy · โครงเพิ่มรายการได้โดยไม่รื้อหน้า |
